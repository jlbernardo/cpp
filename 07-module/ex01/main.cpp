...
/*   Updated: 2024/07/04 15:07:30 by julberna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void){
	...
	println(WHT << "\n Now we have the " << RED << "iter" << WHT << " function."
				<< " It can be used with arrays of any kind");
	println(WHT << " and applies a function to each element. "
					"Here, we are adding 5 to each element:");
	std::cout << GRN << "   ";
	::iter(tab, 5, print);
	std::cout << RED;
