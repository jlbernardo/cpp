...
/*   Updated: 2024/06/05 21:17:16 by julberna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	testWrongAnimalClass(void) {
	...
	println("  One day, however, resulting from a weird experiment,\n  Animal mutated and gave origin to... Something weird.")
...
void	testWrongCatClass(void) {
	...
	println("\n  Its type was \"" << wrongo->getType() << "\", but looked wrong and would sound even wronger.");
		wrongo->makeSound();

	println("\n  Luckily, it was put out of its misery in no time.")
		delete wrongo;
}
