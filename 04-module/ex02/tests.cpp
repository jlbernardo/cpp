...
/*   Updated: 2024/06/06 17:27:30 by julberna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	testBrainyCat(void) {
	...
	println("\n  With the advance of technology, cats got smarter.");
		const AAnimal* catto = new Cat("Oreo");
...
void	testBrainyDog(void) {
	...
	println("  Not as much as cats, but dogs also got smarter.");
		const AAnimal* doggo = new Dog("Cocoa");
...
void	theForbiddenTest(void) {
	/* AAnimal	*forbidden = new AAnimal("Forbidden");
